...
export const SearchInput = ({ value, onChange }: SearchInputProps) => {
  return (
    <div className="group flex w-full max-w-xl items-center rounded-2xl border border-gray-200 bg-white/90 px-4 py-3 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-md transition-all duration-300 hover:border-indigo-200 hover:shadow-[0_14px_35px_rgba(99,102,241,0.10)] focus-within:border-indigo-400 focus-within:shadow-[0_14px_35px_rgba(99,102,241,0.14)]">
      <Search
        size={18}
